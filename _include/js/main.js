...
BRUSHED.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											...
											{image : '_include/img/slider-images/image05.jpg', title : '<div class="slide-content">Brushed</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/image06.jpg', title : '<div class="slide-content">Brushed</div>', thumb : '', url : ''}  
									],
	...
	if($('#projects').length > 0){		
		...
		$container.imagesLoaded(function() {
			$container.isotope({
			  ...
			  filter: '.responsivesitedesign',//This is used to select particular categorey
			  layoutMode : 'fitRows'
